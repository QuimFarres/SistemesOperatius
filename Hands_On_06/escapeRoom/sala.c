...
int main(int argc, char *argv[])
{
    ...
    char c;
    printf("Quines combinacions vols per la contrasenya: \n");
    printf("1 - nomes majuscules \n");
    printf("2 - majuscules i minuscules \n");
    printf("3 - majuscules minuscules i numeros \n");

    scanf("%c", &c);

    char *args[] = {"jugador", "jugador", &c, NULL};
